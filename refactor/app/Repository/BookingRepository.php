...
class BookingRepository extends BaseRepository
{
    ...
    public function bookingExpireNoAccepted()
    {
        ...
        $users = User::select('id','email','user_type')->whereIn('user_type', ['1','2'])->get();
        $all_customers = $users->whereIn('user_type', '1')->lists('email');
        $all_translators = $users->whereIn('user_type', '2')->lists('email');
    ...
    {
        Job::where('id',$id)->update(['ignore', true]);
        return ['success', 'Changes saved'];
    }

    public function ignoreExpired($id)
    {
        Job::where('id',$id)->update(['ignore_expired', true]);
        return ['success', 'Changes saved'];
    }

    public function ignoreThrottle($id)
    {
        Throttles::where('id',$id)->update(['ignore', true]);
        return ['success', 'Changes saved'];
    }
